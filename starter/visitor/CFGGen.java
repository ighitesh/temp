...
public class CFGGen implements GJNoArguVisitor<String> {
   ...
   ProgramCFG cfg;
   public Map<BB, List<Node>> blockToASTMap = new HashMap<>();
...
//      n.f5.accept(this);
   ...
   public String visit(AssignmentStatement n) {
      ...
      BB currentBB = cfg.currentBB; // Get current block
      blockToASTMap.computeIfAbsent(currentBB, k -> new ArrayList<>()).add(n); // Store AST mapping
      cfg.addInstruction(new Instruction(n)); // Add instruction
